...
<div class="space-y-6">
    ...
    @if(!$isAvailable)
        <div class="bg-gray-50 rounded-lg p-6">
            <h4 class="text-lg font-semibold text-black mb-4">{{ __('leads.add_note') }}</h4>
            <div class="space-y-4">
                <div>
                    <label for="noteText" class="block text-sm font-medium text-gray-700 mb-2">{{ __('leads.note') }}</label>
                    <textarea wire:model="noteText" id="noteText" rows="3" 
                              ...
                              placeholder="{{ __('leads.add_note_placeholder') }}"></textarea>
                </div>
                        ...
                        <div class="relative pb-8">
                            <div class="relative flex space-x-3">
                                ...
                                <div class="min-w-0 flex-1 pt-1.5">
                                    <div>
                                        <p class="text-sm font-medium text-black">{{ __('leads.application_submitted') }}</p>
                        ...
                        <li>
                            <div class="relative pb-8">
                                <div class="relative flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5">
                                        <div>
                                            <p class="text-sm font-medium text-black">{{ __('leads.lead_booked') }}</p>
                                            @if($lead->lender)
                        ...
                        <li>
                            <div class="relative pb-8">
                                <div class="relative flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5">
                                        <div>
                                            <p class="text-sm font-medium text-black">{{ __('leads.review_started') }}</p>
                        ...
                        <li>
                            <div class="relative pb-8">
                                <div class="relative flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5">
                                        <div>
                                            <p class="text-sm font-medium text-black">{{ __('leads.application_approved') }}</p>
                        ...
                        <li>
                            <div class="relative pb-8">
                                <div class="relative flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5">
                                        <div>
                                            <p class="text-sm font-medium text-black">{{ __('leads.application_rejected') }}</p>
                                            @if($application->rejection_reasons && count($application->rejection_reasons) > 0)
                                                <div class="mt-1">
                                                    <p class="text-xs text-gray-600 mb-1">{{ __('leads.rejection_reasons') }}</p>
                        ...
                        <li>
                            <div class="relative">
                                <div class="relative flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5">
                                        <div>
                                            <p class="text-sm font-medium text-black">{{ __('leads.loan_disbursed') }}</p>
    ...
    @if(!$isAvailable)
        <div>
            <h3 class="text-lg font-semibold text-black mb-4">{{ __('leads.notes_communications') }}</h3>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center space-x-2 mb-2">
                                <h4 class="text-sm font-medium text-black">{{ __('leads.system_note') }}</h4>
            ...
            <div class="bg-gray-50 rounded-lg p-6">
                <div class="text-center py-8">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-black">{{ __('leads.no_communications_yet') }}</h3>
                    <p class="mt-1 text-sm text-gray-500">{{ __('leads.communications_placeholder') }}</p>
                </div>
            </div>
        </div>
    @else
        ...
        <div>
            ...
            <div class="bg-gray-50 rounded-lg p-6">
                <div class="text-center py-8">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">{{ __('leads.notes_protected') }}</h3>
                    <p class="text-sm text-gray-500">{{ __('leads.book_to_view_notes') }}</p>
                </div>
            </div>
        </div>
    @endif
