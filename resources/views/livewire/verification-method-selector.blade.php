        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            <div class="p-4 sm:p-6 md:p-8">
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                    ...
                    >
                        <div class="border-2 border-gray-200 rounded-xl p-6 transition-all duration-300 group-hover:border-sidebar-green group-hover:shadow-lg group-hover:bg-sidebar-green-50">
                            <div class="text-center">
                                <div class="w-16 h-16 bg-sidebar-green/10 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-sidebar-green/20 transition-colors">
