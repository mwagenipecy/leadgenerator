<div>
    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4" wire:click="closeModals">
        <div class="bg-white rounded-2xl max-w-md w-full" wire:click.stop>
            <div class="p-6">
                <h3 class="text-xl font-bold text-gray-900 mb-4">Delete Blog Post</h3>
                <p class="text-gray-600 mb-6">Are you sure you want to delete "{{ $postToDelete->title }}"? This action cannot be undone.</p>
