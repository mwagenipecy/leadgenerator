                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200 group">
                                    ...
                                    <div class="flex items-center">
                                        <div class="relative">
                                            <div class="w-12 h-12 bg-gradient-to-br 
                                                @if($user->role === 'admin') from-red-600 to-red-700
                                                @elseif($user->role === 'lender') from-red-500 to-red-600
                                                @else from-red-400 to-red-500
                                            ...
                                            @if($user->email_verified_at)
                                                <div class="absolute -bottom-1 -right-1 w-4 h-4 bg-red-400 rounded-full border-2 border-white"></div>
                                            @endif
                                        </div>
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-6 whitespace-nowrap">
                                    <div class="flex flex-col space-y-2">
                                        ...
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                                            @if($user->is_active) bg-red-100 text-red-800 border border-red-200
                                            @else bg-gray-100 text-gray-800 border border-gray-200
                                            @endif">
                                            <div class="w-2 h-2 rounded-full mr-2 {{ $user->is_active ? 'bg-red-400' : 'bg-gray-400' }}"></div>
                                ...
                                <td class="px-6 py-6 whitespace-nowrap">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <button wire:click="toggleUserStatus({{ $user->id }})" 
                                                class="text-{{ $user->is_active ? 'red' : 'gray' }}-600 hover:text-{{ $user->is_active ? 'red' : 'gray' }}-700 p-2 rounded-xl hover:bg-{{ $user->is_active ? 'red' : 'gray' }}-50 transition-all duration-200"
