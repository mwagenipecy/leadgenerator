...
<div class="w-full">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <button wire:click="showCreateForm" class="bg-brand-red text-white px-6 py-2 rounded-lg font-semibold hover:bg-brand-dark-red transition-all duration-200 shadow-lg shadow-brand-red/25">
                        + Create Product
                    </button>
                </div>
            </div>
    ...
    <!-- Total Products -->
    <div class="bg-white rounded-lg shadow-lg p-8 border border-gray-50 hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
        ...
        <div class="relative z-10">
            <div class="flex items-start justify-between mb-6">
                <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center shadow-lg shadow-blue-500/25 group-hover:scale-105 transition-transform duration-300">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8 border border-gray-50 hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
        ...
        <div class="relative z-10">
            <div class="flex items-start justify-between mb-6">
                <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-lg flex items-center justify-center shadow-lg shadow-green-500/25 group-hover:scale-105 transition-transform duration-300">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8 border border-gray-50 hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
        ...
        <div class="relative z-10">
            <div class="flex items-start justify-between mb-6">
                <div class="w-16 h-16 bg-gradient-to-br from-red-500 to-red-600 rounded-lg flex items-center justify-center shadow-lg shadow-red-500/25 group-hover:scale-105 transition-transform duration-300">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                ...
                <div class="flex-1 max-w-md">
                    <div class="relative">
                        ...
                        <input wire:model.live.live="search" type="text" class="block w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red placeholder-gray-500 text-gray-900 text-sm transition-all duration-200" placeholder="Search products...">
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <select wire:model.live.live="employmentFilter" class="bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-brand-red focus:border-brand-red">
...
<div class="bg-white rounded-lg shadow-lg border border-gray-100 overflow-hidden mb-8">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-16 text-center">
                        <div class="flex flex-col items-center">
                            <div class="w-16 h-16 bg-gradient-to-br from-brand-red to-brand-dark-red rounded-lg flex items-center justify-center mb-4">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
                                </svg>
                            </div>
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                <div class="lg:col-span-2">
                                    ...
                                    <input wire:model.live="name" type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red text-lg font-medium" placeholder="e.g., Personal Loan, Business Loan, Emergency Loan">
                            ...
                            <select wire:model.live="loan_type" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red">
                            ...
                            <div class="w-1/2 ">
                                ...
                                <input wire:model.live="promotional_tag" type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red" placeholder="e.g., Best Rate, Quick Approval, No Collateral">
                            ...
                            <div>
                                ...
                                <textarea wire:model.live="description" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red" placeholder="Describe your loan product, its benefits, and who it's designed for..."></textarea>
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center space-x-3">
                                        <input wire:model.live="newKeyFeature" wire:keydown.enter="addKeyFeature" type="text" class="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red" placeholder="Add a key feature (e.g., No hidden fees, Fast approval)">
                                        <button type="button" wire:click="addKeyFeature" class="bg-brand-red text-white px-6 py-3 rounded-lg hover:bg-brand-dark-red transition-colors font-semibold">
                                            Add Feature
                                        </button>
                                    </div>
                            ...
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input wire:model.live="min_amount" type="number" step="1000" min="1000" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red text-lg font-bold">
                                    ...
                                    <div>
                                        ...
                                        <input wire:model.live="max_amount" type="number" step="1000" min="1000" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red text-lg font-bold">
                            ...
                            <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6 border border-green-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input wire:model.live="min_tenure_months" type="number" min="1" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red text-lg font-bold">
                                    ...
                                    <div>
                                        ...
                                        <input wire:model.live="max_tenure_months" type="number" min="1" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red text-lg font-bold">
                            ...
                            <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-6 border border-purple-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div>
                                        ...
                                        <input wire:model.live="interest_rate_min" type="number" step="0.01" min="0" max="100" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red text-lg font-bold">
                                    ...
                                    <div>
                                        ...
                                        <input wire:model.live="interest_rate_max" type="number" step="0.01" min="0" max="100" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red text-lg font-bold">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model.live="interest_type" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red text-lg font-bold">
                            ...
                            <div class="bg-gradient-to-br from-orange-50 to-red-50 rounded-lg p-6 border border-orange-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input wire:model.live="approval_time_days" type="number" min="1" max="90" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red text-lg font-bold">
                                    ...
                                    <div>
                                        ...
                                        <input wire:model.live="disbursement_time_days" type="number" min="1" max="30" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red text-lg font-bold">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            ...
            <input wire:model.live="minimum_dsr" type="number" min="0" max="100" step="0.1" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red text-lg font-bold">
            ...
            <p class="text-sm text-gray-500 mt-1">What is the maximum Debt Service Ratio required for approval?</p>
                            ...
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <select wire:model.live="employment_requirement" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                                            <option value="all">All Employment Types</option>
                                            <option value="employed">Employed Only</option>
                                            <option value="unemployed">Unemployed/Self-Employed</option>
                                        </select>
                                    ...
                                    @if($employment_requirement === 'employed')
                                        <div>
                                            ...
                                            <input wire:model.live="min_employment_months" type="number" min="1" max="120" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                            ...
                            <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6 border border-green-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input wire:model.live="min_age" type="number" min="18" max="100" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                                    ...
                                    <div>
                                        ...
                                        <input wire:model.live="max_age" type="number" min="18" max="100" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                            ...
                            <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-6 border border-purple-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input wire:model.live="min_monthly_income" type="number" step="1000" min="0" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                                    ...
                                    <div>
                                        ...
                                        <input wire:model.live="max_debt_to_income_ratio" type="number" step="0.1" min="0" max="100" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                            ...
                            <div class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg p-6 border border-yellow-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input wire:model.live="min_credit_score" type="number" min="300" max="850" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                            ...
                            <div class="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-lg p-6 border border-indigo-100">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                                    @foreach($businessSectors as $key => $sector)
                                        <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white hover:border-indigo-300 cursor-pointer transition-all duration-200 {{ in_array($key, $selectedBusinessSectors) ? 'bg-indigo-50 border-indigo-300 text-indigo-700' : '' }}">
                ...
                @elseif($currentEditStep === 4)
                    <div class="p-8">
                        ...
                        <div class="space-y-8">
                            <!-- Fees & Charges -->
                            <div class="bg-gradient-to-br from-red-50 to-pink-50 rounded-lg p-6 border border-red-100">
                                <h3 class="text-lg font-bold text-gray-900 mb-4 flex items-center">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input wire:model.live="processing_fee_percentage" type="number" step="0.01" min="0" max="100" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                                    ...
                                    <div>
                                        ...
                                        <input wire:model.live="processing_fee_fixed" type="number" step="1000" min="0" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                                    ...
                                    <div>
                                        ...
                                        <input wire:model.live="late_payment_fee" type="number" step="1000" min="0" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                                    ...
                                    <div>
                                        ...
                                        <input wire:model.live="early_repayment_fee_percentage" type="number" step="0.01" min="0" max="100" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                                        ...
                                        <div>
                                            ...
                                            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                                                @foreach($collateralTypes as $key => $type)
                                                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white hover:border-blue-300 cursor-pointer transition-all duration-200 {{ in_array($key, $selectedCollateralTypes) ? 'bg-blue-50 border-blue-300 text-blue-700' : '' }}">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    @if($requires_guarantor)
                                        <div>
                                            ...
                                            <input wire:model.live="min_guarantors" type="number" min="1" max="5" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                            ...
                            <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-6 border border-purple-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                    @foreach($documentTypes as $key => $type)
                                        <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white hover:border-purple-300 cursor-pointer transition-all duration-200 {{ in_array($key, $selectedDocuments) ? 'bg-purple-50 border-purple-300 text-purple-700' : '' }}">
                            ...
                            <div class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg p-6 border border-yellow-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <label class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-white hover:border-yellow-300 cursor-pointer transition-all duration-200 {{ in_array('bank_transfer', $selectedDisbursementMethods) ? 'bg-yellow-50 border-yellow-300 text-yellow-700' : '' }}">
                                    ...
                                    <label class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-white hover:border-yellow-300 cursor-pointer transition-all duration-200 {{ in_array('mobile_money', $selectedDisbursementMethods) ? 'bg-yellow-50 border-yellow-300 text-yellow-700' : '' }}">
                                    ...
                                    <label class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-white hover:border-yellow-300 cursor-pointer transition-all duration-200 {{ in_array('cash', $selectedDisbursementMethods) ? 'bg-yellow-50 border-yellow-300 text-yellow-700' : '' }}">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    @if($auto_approval_eligible)
                                        <div>
                                            ...
                                            <input wire:model.live="auto_approval_max_amount" type="number" step="1000" min="0" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red font-medium">
                            ...
                            <div class="bg-gradient-to-br from-gray-50 to-slate-50 rounded-lg p-6 border border-gray-200">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <textarea wire:model.live="terms_and_conditions" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red" placeholder="Enter the terms and conditions for this loan product..."></textarea>
                                    ...
                                    <div>
                                        ...
                                        <textarea wire:model.live="eligibility_criteria" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red" placeholder="Summarize the eligibility criteria for this loan..."></textarea>
              ...
              <div class="px-8 py-6 bg-gray-50 border-t border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            ...
                            @else
                                <button type="button" wire:click="backToList" class="bg-gray-100 text-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors flex items-center">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                                    </svg>
                                    Back to List
                        ...
                        <div>
                            ...
                            @else
                                <div class="flex items-center space-x-3">
                                    <button type="button" wire:click="backToList" class="bg-gray-100 text-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors">
                                        Cancel
                                    </button>
                                    <button type="submit" wire:click="saveProduct" class="bg-gradient-to-r from-brand-red to-brand-dark-red text-white px-8 py-3 rounded-lg font-bold hover:from-brand-dark-red hover:to-red-700 transition-all duration-200 shadow-lg shadow-brand-red/25 flex items-center">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                        </svg>
    ...
    @elseif($currentStep === 'view' && $selectedProduct)
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center space-x-3">
                    <button wire:click="editProduct({{ $selectedProduct->id }})" class="bg-brand-red text-white px-6 py-2 rounded-lg font-semibold hover:bg-brand-dark-red transition-all duration-200 shadow-lg shadow-brand-red/25 flex items-center">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                        </svg>
                        Edit Product
                    </button>
                    <button wire:click="backToList" class="text-gray-600 hover:text-gray-800 p-2 rounded-lg hover:bg-gray-100 transition-all duration-200">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                        </svg>
                    </button>
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    <!-- Amount Range -->
    <div class="bg-white rounded-lg p-6 border border-gray-100 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden sticky top-6">
                    ...
                    <div class="p-6" x-data="{ 
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- Results -->
                            <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-4 mt-6">
                            ...
                            <!-- Apply Button -->
                            <button class="w-full bg-gradient-to-r from-brand-red to-brand-dark-red text-white py-3 rounded-lg font-bold hover:from-brand-dark-red hover:to-red-700 transition-all duration-200 shadow-lg shadow-brand-red/25">
                                Apply for This Loan
                            </button>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        <button wire:click="editProduct({{ $selectedProduct->id }})" class="w-full bg-blue-50 text-blue-700 py-3 px-4 rounded-lg font-semibold hover:bg-blue-100 transition-colors flex items-center justify-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                            Edit Product
                        ...
                        <button wire:click="duplicateProduct({{ $selectedProduct->id }})" class="w-full bg-purple-50 text-purple-700 py-3 px-4 rounded-lg font-semibold hover:bg-purple-100 transition-colors flex items-center justify-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button wire:click="toggleProductStatus({{ $selectedProduct->id }})" class="w-full {{ $selectedProduct->is_active ? 'bg-yellow-50 text-yellow-700 hover:bg-yellow-100' : 'bg-green-50 text-green-700 hover:bg-green-100' }} py-3 px-4 rounded-lg font-semibold transition-colors flex items-center justify-center">
                        ...
                        <div class="border-t border-gray-200 pt-3 mt-4">
                            <button onclick="window.print()" class="w-full bg-gray-50 text-gray-700 py-3 px-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
