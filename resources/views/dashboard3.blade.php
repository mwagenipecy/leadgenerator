...
<head>
    ...
    <title>Dashboard - Fanikisha</title>
...
<body class="bg-accent-gray font-inter">
    <div class="flex h-screen overflow-hidden">
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-72 bg-sidebar-black shadow-2xl transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0">
            <!-- Logo Section -->
            <div class="flex items-center justify-center h-20 px-6 bg-gradient-to-r from-sidebar-green via-brand-dark-red to-sidebar-green-900 relative overflow-hidden">
                ...
                <div class="flex items-center space-x-4 relative z-10">
                    ...
                    <div>
                        ...
                        <p class="text-sidebar-green-200 text-xs font-medium mt-0.5">Advanced Analytics</p>
                    </div>
                </div>
            </div>
            ...
            <nav class="mt-8 px-4 pb-4">
                <div class="space-y-3">
                    <!-- Dashboard - Active -->
                    <a href="#" class="group flex items-center px-5 py-4 text-sm font-semibold rounded-2xl bg-gradient-to-r from-sidebar-green/90 to-brand-dark-red text-white shadow-lg shadow-sidebar-green/20 transform transition-all duration-200 hover:scale-105">
                    ...
                    <a href="#" class="group flex items-center px-5 py-4 text-sm font-medium text-gray-300 rounded-2xl hover:bg-sidebar-gray hover:text-white transition-all duration-200 hover:shadow-lg">
                        <svg class="mr-4 h-5 w-5 group-hover:text-sidebar-green transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                        </svg>
                        Lead Management
                        <span class="ml-auto bg-sidebar-green text-white text-xs px-2.5 py-1.5 rounded-full font-bold shadow-md">24</span>
                    </a>
                ...
                <!-- Support Section -->
                <div class="bg-gradient-to-br from-sidebar-green/10 via-brand-dark-red/5 to-transparent rounded-2xl p-5 border border-sidebar-green/20">
                    <div class="flex items-start space-x-4">
                        <div class="w-12 h-12 bg-sidebar-green/20 rounded-xl flex items-center justify-center border border-sidebar-green/30">
                        ...
                        <div>
                            ...
                            <button class="bg-gradient-to-r from-sidebar-green to-brand-dark-red text-white text-xs font-semibold py-2 px-4 rounded-lg hover:shadow-lg hover:shadow-sidebar-green/25 transition-all duration-200 w-full">
                                Get Help Now
                            </button>
                        </div>
                    </div>
                ...
                <div class="mt-6 px-2">
                    <div class="bg-sidebar-gray rounded-2xl p-4 hover:bg-gray-800 transition-colors duration-200 cursor-pointer">
                        <div class="flex items-center space-x-3">
                            <div class="w-12 h-12 bg-gradient-to-br from-sidebar-green to-brand-dark-red rounded-xl flex items-center justify-center shadow-lg">
        ...
        <div class="flex-1 overflow-hidden lg:ml-0">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200">
                <div class="flex items-center justify-between px-8 py-4">
                    <!-- Mobile menu button -->
                    <button id="mobile-menu-button" class="lg:hidden p-2 rounded-xl text-gray-600 hover:text-sidebar-green hover:bg-gray-100 transition-all duration-200">
                    ...
                    <div class="flex-1 max-w-2xl mx-6">
                        <div class="relative">
                            ...
                            <input type="text" class="block w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-sidebar-green focus:border-sidebar-green placeholder-gray-500 text-gray-900 text-sm transition-all duration-200" placeholder="Search leads, campaigns, or reports...">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        <!-- Quick Actions -->
                        <button class="bg-sidebar-green text-white px-4 py-2 rounded-xl font-semibold hover:bg-brand-dark-red transition-all duration-200 shadow-lg shadow-sidebar-green/25 hover:shadow-sidebar-green/40">
                            + Add Lead
                        </button>

                        <!-- Notifications -->
                        <button class="relative p-3 text-gray-600 hover:text-sidebar-green hover:bg-gray-100 rounded-xl transition-all duration-200">
                            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
                            </svg>
                            <span class="absolute -top-1 -right-1 h-5 w-5 bg-sidebar-green rounded-full flex items-center justify-center">
                        ...
                        <div class="relative">
                            <button class="flex items-center space-x-3 p-2 rounded-xl hover:bg-gray-100 transition-all duration-200 group">
                                <div class="w-10 h-10 bg-gradient-to-br from-sidebar-green to-brand-dark-red rounded-xl flex items-center justify-center shadow-md">
                                    <span class="text-white text-sm font-bold">JD</span>
                                </div>
                                <div class="hidden md:block text-left">
                                    <p class="text-sm font-semibold text-gray-900 group-hover:text-sidebar-green transition-colors">John Doe</p>
