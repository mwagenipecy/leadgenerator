@props(['icon' => 'document-text', 'class' => 'w-5 h-5'])
@php
$paths = [
    ...
    'puzzle' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>',
    ...
    'language' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129"/>',
    ...
    'truck' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/>',
    ...
    'map' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.196-5.196a2.25 2.25 0 013.182-3.182L9 13.182l5.196-5.196a2.25 2.25 0 013.182 3.182L9 20z"/>',
];
$path = $paths[$icon] ?? $paths['document-text'];
@endphp
<svg class="{{ $class }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">{!! $path !!}</svg>
