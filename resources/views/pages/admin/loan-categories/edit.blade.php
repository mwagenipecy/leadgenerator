<x-app-layout>
    <div class="p-6">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-black">Edit Loan Category</h1>
            <p class="text-gray-600 mt-1">Update loan category details</p>
        </div>

        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 max-w-2xl">
            <form action="{{ route('admin.loan-categories.update', $loanCategory->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="Brief description of this loan category">{{ old('description', $loanCategory->description) }}</textarea>
                        @error('description')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
