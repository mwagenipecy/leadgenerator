...
<body class="font-inter bg-gray-50">
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl w-full text-center">
            ...
            <div class="mb-6">
                <h1 class="text-9xl font-bold text-brand-red font-poppins">403</h1>
            </div>

            <div class="mb-8">
                <h2 class="text-3xl font-bold text-gray-900 mb-4 font-poppins">Access Denied</h2>
                <p class="text-lg text-gray-600">You do not have permission to access this page.</p>
            </div>
            ...
            <div class="mt-8 pt-8 border-t border-gray-200">
                <p class="text-sm text-gray-500">Error code: 403 Forbidden</p>
            </div>
        </div>
    </div>
</body>
