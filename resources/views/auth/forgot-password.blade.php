...
@php
    ...
    $authSideImageValue = \App\Models\SystemSetting::getValue('auth_side_image_forgot_password_' . app()->getLocale())
        ?: \App\Models\SystemSetting::getValue('auth_side_image_forgot_password_en')
